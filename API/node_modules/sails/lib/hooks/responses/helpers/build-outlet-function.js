 ...
 * buildOutletFunction()
 *
 * Return an outlet function which can be called to terminate a response.
 *
 ...
 *
 * @return {Function} an outlet function which sends a response
 *
 * @api private
 */
module.exports = function buildOutletFunction (req, res, data, options, config) {
