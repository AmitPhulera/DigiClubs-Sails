...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/error/WLValidationError.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/error/</a> WLValidationError.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  // Ensure valid usage
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.invalidAttributes !== 'object') {
