...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/core/validations.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/core/</a> validations.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6568×</span>
<span class="cline-any cline-yes">6535×</span>
<span class="cline-any cline-yes">3503×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3065×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3060×</span>
...
<span class="cline-any cline-yes">3030×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1318×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      // Ignore null values
      <span class="missing-if-branch" title="if path not taken" >I</span>if (attrs[attr][prop] === null) { <span class="cstat-no" title="statement not covered" >return; </span>}
&nbsp;
...
&nbsp;
  ...
  switch (typeof presentOnly) {
    ...
    case 'string':
      ...
      break;
    case 'object':
      <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(presentOnly)) {
        validations = presentOnly;
        break;
...
&nbsp;
    ...
    if (curValidation.required &amp;&amp; curValidation.type === 'boolean' &amp;&amp; (typeof value !== 'undefined' &amp;&amp; value !== null)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (value.toString() === 'true' || <span class="branch-1 cbranch-no" title="branch not covered" >value.toString() === 'false')</span> {
        return cb();
      }
    }
&nbsp;
    ...
    if (hasOwnProperty(self.validations[validation], 'type') &amp;&amp; self.validations[validation].type === 'integer') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (utils.matchMongoId(value)) {
...
<span class="cstat-no" title="statement not covered" >        return next(e);</span>
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (unexpectedErr) {
        // Handle fatal error
...
&nbsp;
      ...
      if (requirements.data.hasOwnProperty('required') &amp;&amp; !requirements.data.required) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isNull(value)) {
<span class="cstat-no" title="statement not covered" >          return cb();</span>
        }
      }
&nbsp;
...
&nbsp;
      validationError.forEach(function(obj) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (obj.property) {
