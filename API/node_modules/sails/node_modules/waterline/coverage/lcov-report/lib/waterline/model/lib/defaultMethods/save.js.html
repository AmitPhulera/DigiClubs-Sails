...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/model/lib/defaultMethods/save.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">all files</a> / <a href="index.html">lib/waterline/model/lib/defaultMethods/</a> save.js
    </h1>
    <div class='clearfix'>
...
219
220
221</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(previousVal)) {
<span class="cstat-no" title="statement not covered" >          previousVal = previousVal[0];</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (deep(currentVal, previousVal)) {
...
&nbsp;
  function(err, results) {
    if (err) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (deferred) {
...
&nbsp;
    if (!results.updateRecord.length) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (deferred) {
