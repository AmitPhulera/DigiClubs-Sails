...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hop(adapter, 'syncable') &amp;&amp; !adapter.syncable) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.migrate &amp;&amp; ['drop', 'alter', 'create', 'safe'].indexOf(this.migrate) &gt; -1) {
&nbsp;
