...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/dql/create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/dql/</a> create.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">972×</span>
<span class="cline-any cline-yes">8528×</span>
...
&nbsp;
  _.each(_.keys(values), function(key) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Buffer.isBuffer(values[key])) {
...
&nbsp;
  ...
  _.each(_.keys(bufferValues), <span class="fstat-no" title="function not covered" >function(key) {</span>
...
&nbsp;
  ...
  if (self.autoCreatedAt) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!valuesObject.values[self.autoCreatedAt]) {
      date = date || new Date();
...
&nbsp;
  if (self.autoUpdatedAt) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!valuesObject.values[self.autoUpdatedAt]) {
