...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/adapter/compoundQueries.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/adapter/</a> compoundQueries.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!values) <span class="cstat-no" title="statement not covered" >values = criteria.where ? criteria.where : criteria;</span>
&nbsp;
    // Normalize Arguments
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hasOwnProperty(this.dictionary, 'findOrCreate')) {
...
<span class="cstat-no" title="statement not covered" >        return adapter.findOrCreate(connName, this.collection, values, cb, metaContainer);</span>
      }
    }
&nbsp;
    // Default behavior
