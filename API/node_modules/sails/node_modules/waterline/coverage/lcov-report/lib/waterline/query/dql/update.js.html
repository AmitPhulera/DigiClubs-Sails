...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/dql/update.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/dql/</a> update.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!values) <span class="cstat-no" title="statement not covered" >return usageError('No updated values specified!', usage, cb);</span>
&nbsp;
...
&nbsp;
    ...
    var modelName;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hop(attribute, 'collection')) <span class="cstat-no" title="statement not covered" >modelName = attribute.collection;</span>
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hop(attribute, 'model')) modelName = attribute.model;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!modelName) <span class="cstat-no" title="statement not covered" >return next();</span>
&nbsp;
...
&nbsp;
    var criteria = {};
&nbsp;
    var pkField = hop(model._transformer._transformations, model.primaryKey) ? <span class="branch-0 cbranch-no" title="branch not covered" >model._transformer._transformations[model.primaryKey] </span>: model.primaryKey;
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if(metaContainer) {
<span class="cstat-no" title="statement not covered" >      query.meta(metaContainer);</span>
    }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.autoUpdatedAt) {
...
&nbsp;
  ...
  self.adapter.update(valuesObject.criteria, valuesObject.values, function(err, values) {
    if (err) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof err === 'object') { err.model = self._model.globalId; }
      return cb(err);
    }
&nbsp;
...
&nbsp;
  var self = this;
  var associations = valuesObject.associations || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
