...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/finders/operations.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/finders/</a> operations.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.98% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>234/249</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">82% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>82/100</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(this.context.waterline.collections, collectionName)) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (result[item.join.parentKey] === null || typeof result[item.join.parentKey] === undefined) <span class="cstat-no" title="statement not covered" >return;</span>
      parents.push(result[item.join.parentKey]);
&nbsp;
    });
&nbsp;
    // If no parents match the join criteria, don't build up an operation
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parents.length === 0) <span class="cstat-no" title="statement not covered" >return next();</span>
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (hasOwnProperty(userCriteria, 'where')) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (userCriteria.where === undefined) {
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(userCriteria.where)) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (hasOwnProperty(_tmpCriteria, 'limit')) tmpCriteria.limit = _tmpCriteria.limit;
&nbsp;
...
&nbsp;
  ...
  var i = 0;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!opts || opts.length === 0) <span class="cstat-no" title="statement not covered" >return cb(null, {});</span>
&nbsp;
...
&nbsp;
      ...
      self.cache[opt.collection] = self.cache[opt.collection] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
&nbsp;
  // Check if the join contains any criteria
  <span class="missing-if-branch" title="else path not taken" >E</span>if (opt.join.criteria) {
...
&nbsp;
  return pk || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
