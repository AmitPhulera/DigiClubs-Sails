...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/adapter/aggregateQueries.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/adapter/</a> aggregateQueries.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hasOwnProperty(this.dictionary, 'createEach')) {
...
<span class="cstat-no" title="statement not covered" >        return adapter.createEach(connName, this.collection, valuesList, cb, metaContainer);</span>
      }
    }
&nbsp;
    // Default behavior
...
&nbsp;
    ...
    if (hasOwnProperty(this.dictionary, 'findOrCreateEach')) {
      ...
      adapter = this.connections[connName]._adapter;
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (hasOwnProperty(adapter, 'findOrCreateEach')) {
...
&nbsp;
    async.eachSeries(valuesList, function(values, cb) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(values)) <span class="cstat-no" title="statement not covered" >return cb(new Error('findOrCreateEach: Unexpected value in valuesList.'));</span>
      // Check that each of the criteria keys match:
      // build a criteria query
      var criteria = {};
&nbsp;
      if (isObjectArray) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isObject(attributesToCheck[i])) {
...
&nbsp;
        // Add model to list
        <span class="missing-if-branch" title="else path not taken" >E</span>if (model) models.push(model);
&nbsp;
        cb(null, model);
      }, metaContainer);
    }, function(err) {
