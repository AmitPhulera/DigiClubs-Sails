...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/dql/count.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/dql/</a> count.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isFunction(criteria) || _.isFunction(options)) {
