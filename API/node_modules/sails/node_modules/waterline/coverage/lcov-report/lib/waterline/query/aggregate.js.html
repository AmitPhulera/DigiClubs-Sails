...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/aggregate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> aggregate.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!valuesList) <span class="cstat-no" title="statement not covered" >return usageError('No valuesList specified!', usage, cb);</span>
    if (!Array.isArray(valuesList)) return usageError('Invalid valuesList specified (should be an array!)', usage, cb);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof cb !== 'function') <span class="cstat-no" title="statement not covered" >return usageError('Invalid callback specified!', usage, cb);</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof cb !== 'function') <span class="cstat-no" title="statement not covered" >return usageError('Invalid callback specified!', usage, cb);</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!criteria) <span class="cstat-no" title="statement not covered" >return usageError('No criteria specified!', usage, cb);</span>
...
&nbsp;
  ...
  for (var key in self.attributes) {
    if (!record[key] &amp;&amp; record[key] !== false &amp;&amp; hasOwnProperty(self.attributes[key], 'defaultsTo')) {
      ...
      record[key] = typeof defaultsTo === 'function' ? <span class="branch-0 cbranch-no" title="branch not covered" >defaultsTo.call(record) </span>: _.clone(defaultsTo);
    }
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (self.autoCreatedAt) {
      record[self.autoCreatedAt] = new Date();
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (self.autoUpdatedAt) {
