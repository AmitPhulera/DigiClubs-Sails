...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> waterline.js
    </h1>
    <div class='clearfix'>
...
281
282
283</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Waterline)) {
<span class="cstat-no" title="statement not covered" >    return new Waterline();</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!options) <span class="cstat-no" title="statement not covered" >throw new Error('Usage Error: function(options, callback)');</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.adapters) <span class="cstat-no" title="statement not covered" >throw new Error('Options object must contain an adapters object');</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.connections) <span class="cstat-no" title="statement not covered" >throw new Error('Options object must contain a connections object');</span>
&nbsp;
  // Allow collections to be passed in to the initialize method
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.collections) {
<span class="cstat-no" title="statement not covered" >    for (var collection in options.collections) {</span>
<span class="cstat-no" title="statement not covered" >      this.loadCollection(options.collections[collection]);</span>
    }
&nbsp;
    // Remove collections from the options after they have been loaded
<span class="cstat-no" title="statement not covered" >    delete options.collections;</span>
  }
&nbsp;
...
&nbsp;
        ...
        connection._collections.forEach(function(coll) {
          var identity = coll;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (hasOwnProperty(self.collections[coll].__proto__, 'tableName')) {
...
&nbsp;
        ...
        connection._adapter.registerConnection(config, usedSchemas, function(err) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >return nextItem(err);</span>
          nextItem();
        });
      }, next);
    }]
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(connection._adapter, 'teardown')) <span class="cstat-no" title="statement not covered" >return next();</span>
&nbsp;
