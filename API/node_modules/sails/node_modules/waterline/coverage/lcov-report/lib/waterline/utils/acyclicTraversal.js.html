...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/acyclicTraversal.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/</a> acyclicTraversal.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!relation) <span class="cstat-no" title="statement not covered" >throw new Error('Unknown relation in schema: ' + modelIdentity + '.' + nameOfRelation);</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (relation.via) {
      alreadyTraversed.push({
        alias: relation.via,
