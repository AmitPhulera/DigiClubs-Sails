...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/finders/helpers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/finders/</a> helpers.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!criteria) <span class="cstat-no" title="statement not covered" >return usageError('Criteria must be an object!', usage, cb);</span>
&nbsp;
