...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/model/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/model/</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2586×</span>
<span class="cline-any cline-yes">22152×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">22152×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20657×</span>
...
&nbsp;
        ...
        if (type === 'array' || type === 'json') {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isString(values[key])) return;
...
&nbsp;
        ...
        if (type === 'boolean') {
          var val = values[key];
          <span class="missing-if-branch" title="if path not taken" >I</span>if (val === 0) <span class="cstat-no" title="statement not covered" >values[key] = false;</span>
          <span class="missing-if-branch" title="if path not taken" >I</span>if (val === 1) <span class="cstat-no" title="statement not covered" >values[key] = true;</span>
        }
&nbsp;
      });
    },
...
<span class="cstat-no" title="statement not covered" >          cb();</span>
        ...
        return new Bluebird(function(resolve, reject) {
          context.validate(values, function(err) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (err) { return reject(err); }
