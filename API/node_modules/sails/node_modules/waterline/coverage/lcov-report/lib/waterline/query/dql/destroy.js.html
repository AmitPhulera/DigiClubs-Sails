...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/dql/destroy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/dql/</a> destroy.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!self.attributes[key].primaryKey) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
...
&nbsp;
        ...
        // than crashing.
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!refKey) <span class="cstat-no" title="statement not covered" >return next();</span>
&nbsp;
        // Make sure we don't return any undefined pks
        var mappedValues = result.reduce(function(memo, vals) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (vals[pk] !== undefined) {
            memo.push(vals[pk]);
          }
          return memo;
        }, []);
...
<span class="cstat-no" title="statement not covered" >            q.meta(metaContainer);</span>
          }
&nbsp;
          q.exec(next);
        } else {
