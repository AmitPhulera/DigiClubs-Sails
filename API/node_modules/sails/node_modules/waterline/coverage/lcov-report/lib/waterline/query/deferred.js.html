...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/deferred.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> deferred.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.13% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>170/207</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.84% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>99/124</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>166/196</span>
      </div>
    </div>
  </div>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!context) <span class="cstat-no" title="statement not covered" >return new Error('Must supply a context to a new Deferred object. Usage: new Deferred(context, method, criteria)');</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!method) <span class="cstat-no" title="statement not covered" >return new Error('Must supply a method to a new Deferred object. Usage: new Deferred(context, method, criteria)');</span>
&nbsp;
...
&nbsp;
    ...
    criteria.where = criteria.where === false ? <span class="branch-0 cbranch-no" title="branch not covered" >false </span>: (criteria.where || {});
    ////////////////////////////////////////////////////////////////////////
&nbsp;
  } catch (e) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!attr) {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
...
&nbsp;
    ...
    var select = [];
    var customSelect = criteria.select &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.isArray(criteria.select);</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if(customSelect &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!_.includes(criteria.select, key))</span> {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.has(val, 'columnName')) {
          selects.push(key);
          return;
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        selects.push(val.columnName);</span>
      });
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (criteria) {
 ...
 */
&nbsp;
Deferred.prototype.select = <span class="fstat-no" title="function not covered" >function(attributes) {</span>
<span class="cstat-no" title="statement not covered" >  if(!_.isArray(attributes)) {</span>
<span class="cstat-no" title="statement not covered" >    attributes = [attributes];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var select = this._criteria.select || [];</span>
<span class="cstat-no" title="statement not covered" >  select = select.concat(attributes);</span>
<span class="cstat-no" title="statement not covered" >  this._criteria.select = _.uniq(select);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!criteria) <span class="cstat-no" title="statement not covered" >return this;</span>
&nbsp;
  // If the criteria is an array of objects, wrap it in an "or"
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(criteria) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.all(criteria, <span class="fstat-no" title="function not covered" >function(crit) {<span class="cstat-no" title="statement not covered" ></span>return _.isObject(crit);}</span>))</span> {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (criteria === false) {
<span class="cstat-no" title="statement not covered" >    this._criteria = false;</span>
  }
&nbsp;
  if (!criteria || !criteria.where) return this;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._criteria) <span class="cstat-no" title="statement not covered" >this._criteria = {};</span>
...
&nbsp;
  ...
  var skip = 0;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (page &gt; 0 &amp;&amp; limit === 0) <span class="cstat-no" title="statement not covered" >skip = page - 1;</span>
 ...
 */
&nbsp;
Deferred.prototype.meta = <span class="fstat-no" title="function not covered" >function(data) {</span>
<span class="cstat-no" title="statement not covered" >  this._meta = data;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    console.log('Error: No Callback supplied, you must define a callback.');</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(this._meta) {
<span class="cstat-no" title="statement not covered" >    args.push(this._meta);</span>
  }
&nbsp;
...
&nbsp;
  this._criteria[key] = args || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
}
&nbsp;</pre></td></tr>
</table></pre>
