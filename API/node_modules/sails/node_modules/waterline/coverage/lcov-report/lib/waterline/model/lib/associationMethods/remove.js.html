...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/model/lib/associationMethods/remove.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">all files</a> / <a href="index.html">lib/waterline/model/lib/associationMethods/</a> remove.js
    </h1>
    <div class='clearfix'>
...
293
294
295</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.primaryKey) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!proto.toObject()[this.primaryKey]) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!primaryKey &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >hasOwnProperty(values, 'id'))</span> <span class="cstat-no" title="statement not covered" >primaryKey = 'id';</span>
&nbsp;
  return primaryKey;
};
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!associationKey) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isString(key) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >utils.matchMongoId(key))</span> <span class="cstat-no" title="statement not covered" >validAssociation = true;</span>
&nbsp;
