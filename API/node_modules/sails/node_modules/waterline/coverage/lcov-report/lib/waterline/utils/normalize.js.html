...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/normalize.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/</a> normalize.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.53% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>153/181</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.41% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>158/185</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>140/158</span>
      </div>
    </div>
  </div>
...
431
432
433</td><td class="line-coverage quiet"><span class="cline-any cline-yes">3×</span>
...
<span class="cline-any cline-yes">4045×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">5408×</span>
<span class="cline-any cline-yes">5373×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5373×</span>
<span class="cline-any cline-yes">5303×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.attributes[key].primaryKey) <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
...
&nbsp;
      // Otherwise just coerce the one
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isObject(options[pk])) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (criteria === false) <span class="cstat-no" title="statement not covered" >return criteria;</span>
&nbsp;
    if (!criteria) {
      return {
        where: null
...
&nbsp;
    ...
    _.each(criteria, function(val, key) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isUndefined(val)) <span class="cstat-no" title="statement not covered" >criteria[key] = null;</span>
    });
&nbsp;
    // Convert non-objects (ids) into a criteria
    // TODO: use customizable primary key attribute
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(criteria)) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(criteria)) <span class="cstat-no" title="statement not covered" >throw new WLUsageError('Invalid options/criteria :: ' + criteria);</span>
&nbsp;
...
&nbsp;
    ...
    if (hop(criteria, 'where') &amp;&amp; criteria.where !== null &amp;&amp; hop(criteria.where, 'limit')) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (criteria.limit &lt; 0) <span class="cstat-no" title="statement not covered" >criteria.limit = 0;</span>
...
&nbsp;
    if (hop(criteria, 'where') &amp;&amp; criteria.where !== null &amp;&amp; hop(criteria.where, 'skip')) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (criteria.skip &lt; 0) <span class="cstat-no" title="statement not covered" >criteria.skip = 0;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hop(criteria, 'where') &amp;&amp; criteria.where !== null &amp;&amp; hop(criteria.where, 'min')) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hop(criteria, 'where') &amp;&amp; criteria.where !== null &amp;&amp; hop(criteria.where, 'max')) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if(!_.isArray(criteria.select)) {
<span class="cstat-no" title="statement not covered" >        criteria.select = [criteria.select];</span>
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if(_.includes(criteria.select, '*')) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isArray(criteria.where.or)) {
...
&nbsp;
      ...
      criteria.where.or.forEach(function(clause, i) {
        Object.keys(clause).forEach(function(key) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(clause[key]) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >clause[key].length === 0)</span> {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(criteria.sort) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!_.isFunction(criteria.sort))</span> {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (criteria !== Object(criteria)) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
