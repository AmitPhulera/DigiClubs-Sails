...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/composite.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/</a> composite.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof cb == 'function' &amp;&amp; (!criteria || criteria.length === 0)) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if(metaContainer) {
<span class="cstat-no" title="statement not covered" >        q2.meta(metaContainer);</span>
      }
&nbsp;
