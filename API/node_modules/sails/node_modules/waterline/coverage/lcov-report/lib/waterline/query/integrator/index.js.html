...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/integrator/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/integrator/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      // 1 ..N Association
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (instructions.length === 1) {
&nbsp;
        // Name keys explicitly
        // (makes it easier to see what's going on)
        parentPK = primaryKey;
