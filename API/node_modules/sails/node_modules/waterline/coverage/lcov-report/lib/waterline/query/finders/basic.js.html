...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/query/finders/basic.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/query/finders/</a> basic.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.83% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>175/222</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">76.54% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>124/162</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>164/196</span>
      </div>
    </div>
  </div>
...
&nbsp;
  findOne: function(criteria, cb, metaContainer) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof criteria === 'function') {
...
&nbsp;
    ...
    operations.run(function(err, values) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!values.cache) <span class="cstat-no" title="statement not covered" >return cb();</span>
&nbsp;
...
&nbsp;
      ...
      Integrator(values.cache, criteria.joins, primaryKey, function(err, results) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >return cb(err);</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!results) <span class="cstat-no" title="statement not covered" >return cb();</span>
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!tmpCriteria) <span class="cstat-no" title="statement not covered" >tmpCriteria = {};</span>
&nbsp;
        criteria.joins.forEach(function(join) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(join, 'alias')) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
          // Check for `OR` criteria
          <span class="missing-if-branch" title="if path not taken" >I</span>if (hasOwnProperty(tmpCriteria, 'or')) {
...
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!hasOwnProperty(tmpCriteria, join.alias)) return;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!data || !data.models || !data.models.forEach) {
...
<span class="cstat-no" title="statement not covered" >        metaContainer = cb;</span>
...
&nbsp;
    // Validate Arguments
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof criteria === 'function' || typeof options === 'function') {
...
&nbsp;
    // Transform Search Criteria
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!self._transformer) {
...
&nbsp;
        // Normalize results to an array
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(results) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >results)</span> <span class="cstat-no" title="statement not covered" >results = [results];</span>
&nbsp;
        // Unserialize each of the results before attempting any join logic on them
        var unserializedModels = [];
&nbsp;
