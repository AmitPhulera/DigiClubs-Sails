...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/model/lib/defaultMethods/toObject.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">all files</a> / <a href="index.html">lib/waterline/model/lib/defaultMethods/</a> toObject.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.47% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>102/114</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
      values.forEach(function(record) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof record !== 'object') <span class="cstat-no" title="statement not covered" >return;</span>
        // Since `typeof null` === `"object"`, we should also check for that case:
        <span class="missing-if-branch" title="if path not taken" >I</span>if (record === null) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isDate(record)) {
&nbsp;
...
&nbsp;
      self.object[association].forEach(function(item) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(item.__proto__, 'toJSON')) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(self.object[association].__proto__, 'toJSON')) <span class="cstat-no" title="statement not covered" >return;</span>
...
toObject.prototype.filterFunctions = function() {
  for (var key in this.object) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.object[key] === 'function') {
