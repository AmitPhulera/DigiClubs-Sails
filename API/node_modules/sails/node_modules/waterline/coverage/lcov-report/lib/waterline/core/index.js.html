...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/core/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/core/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  this.connections = this.connections || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(connection, '_adapter')) <span class="cstat-no" title="statement not covered" >return true;</span>
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!hasOwnProperty(connection._adapter, 'schema')) return true;
&nbsp;
