...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/schema.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/</a> schema.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">5308×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">270×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2160×</span>
<span class="cline-any cline-yes">2102×</span>
<span class="cline-any cline-yes">2102×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
schema.instanceMethods = function(attrs) {
  var methods = {};
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!attrs) <span class="cstat-no" title="statement not covered" >return methods;</span>
&nbsp;
  Object.keys(attrs).forEach(function(key) {
...
&nbsp;
      ...
      for (_i = 0, _len = context[fn].length; _i &lt; _len; _i = _i + 1) {
        if (typeof context[fn][_i] === 'string') {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof context.attributes[context[fn][_i]] === 'function') {
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Unable to locate callback `' + context[fn][_i] + '`');</span>
      ...
      // Attempt to map string to function
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof context.attributes[context[fn]] === 'function') {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!criteria.joins) <span class="cstat-no" title="statement not covered" >return criteria;</span>
&nbsp;
  var joins = _.cloneDeep(criteria.joins);
&nbsp;
  joins.forEach(function(join) {
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(collections[join.parent], 'tableName')) <span class="cstat-no" title="statement not covered" >return;</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(collections[join.child], 'tableName')) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
