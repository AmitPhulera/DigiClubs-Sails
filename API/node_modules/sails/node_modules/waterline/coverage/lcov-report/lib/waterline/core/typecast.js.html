...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/core/typecast.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/core/</a> typecast.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3420×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
Cast.prototype.run = function(values) {
  var self = this;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (values === undefined || values === null) {
...
Cast.prototype.string = function string(str) {
  return typeof str.toString !== 'undefined' ? str.toString() : <span class="branch-1 cbranch-no" title="branch not covered" >'' + str;</span>
};
&nbsp;
/**
 * Cast Integer Values
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_value.toString() === 'Invalid Date') <span class="cstat-no" title="statement not covered" >return value;</span>
  return _value;
};
&nbsp;
/**
