...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/utils/nestedOperations/create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/waterline/utils/nestedOperations/</a> create.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  associations.forEach(function(association) {
    ...
    var modelName;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hasOwnProperty(attribute, 'collection')) modelName = attribute.collection;
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!optValues) <span class="cstat-no" title="statement not covered" >return;</span>
    if (!_.isArray(optValues)) {
      optValues = _.isString(optValues) ? <span class="branch-0 cbranch-no" title="branch not covered" >optValues.split(',') </span>: [optValues];
    }
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (relatedPK.autoIncrement &amp;&amp; related.autoPK &amp;&amp; hasOwnProperty(val, pk)) {
