...
<html lang="en">
<head>
    <title>Code coverage report for lib/waterline/collection/loader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/waterline/collection/</a> loader.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(collection.prototype, 'tableName') &amp;&amp; !hasOwnProperty(collection.prototype, 'identity')) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(collection.prototype, 'connection')) {
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hasOwnProperty(connections, conn)) {
