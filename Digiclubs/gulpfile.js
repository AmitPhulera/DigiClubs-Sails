...
gulp.task('fonts', function() {
  ...
  .pipe(gulp.dest(path.join(config.dest, 'fonts/roboto')));
});
...
/*====================================================================
=            Import some of the vendor css files                     =
====================================================================*/

gulp.task('importCss', function () {
  gulp.src(['./bower_components/materialize/dist/css/materialize.min.css','./bower_components/material-design-icons/iconfont/material-icons.css'])
    .pipe(importCss())
    .pipe(gulp.dest(path.join(config.dest, 'css')));
});
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
      ...
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'DigiClubs' }))
    )
